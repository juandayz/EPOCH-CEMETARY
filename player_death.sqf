...
////CEMETARY
_coins = _body getVariable [Z_moneyVariable,0];
_position = [_customPosition, 1, 15, 2, 0, 20, 0] call BIS_fnc_findSafePos;
...
_crate setVariable[Z_moneyVariable,_coins,true];
